...
> **Вы:** Какие объявления за последние 7 дней потратили больше всего и не дали конверсий?
>
> **Ассистент:** Находит доступные кампании и группы, получает статистику по объявлениям за период и показывает объявления с расходом, показами и кликами. Если API возвращает метрики конверсий, включает их в сравнение.
>
> **Вы:** Почему одно из объявлений не показывается?
>
> **Ассистент:** Показывает его статус, статус доставки и модерации. Объясняет, связано ли отсутствие показов с паузой, модерацией или другой диагностикой кабинета.

<img src="docs/demo.gif" alt="Демонстрация: ассистент сопоставляет кампании, статистику и баланс VK Рекламы" width="1000">

<sub>Демонстрация использует записанные ответы VK Ads API, поэтому воспроизводится без токена и сети. Исходники: <a href="docs/demo">docs/demo</a> и <a href="docs/demo.tape">docs/demo.tape</a>.</sub>
